...
## 🚀 About Me
- 🔭 **主攻方向**：HarmonyOS NEXT 纯鸿蒙原生开发、跨端音乐播放器、Vue3 企业级前端应用开发
- 🌱 **持续学习**：ArkTS 语法优化、HarmonyOS 全场景设备适配、Express + SQLite 轻量级后端架构
- 📱 **鸿蒙实践**：深耕鸿蒙原生UI/UX、AbilityStage 生命周期、跨设备数据通信
- 🎵 **项目特色**：专注音乐类APP的交互设计与性能优化，追求极致的视听体验
- 🏋️‍♂️ **业务落地**：独立开发健身房管理系统，实现业务场景数字化、流程自动化
- 💬 **交流合作**：欢迎探讨鸿蒙生态开发、跨端技术、前端工程化问题，随时Issues/私信
- 📫 **星标支持**：我的鸿蒙/前端项目欢迎 Star & Fork，一起共建开源生态！
